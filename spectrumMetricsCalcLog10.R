# 01.06.2016 script to calculate regression parameters for each file, average them, plot the
# resulting regressions, MW them against baseline. Log10 version
...
write.csv(metricsFrame, 
          "/home/somros/Documents/itn100results/sizeSpectrum2000/spectrumMetricsTables/log10/S250_I3.csv")
